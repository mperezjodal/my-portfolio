  ...
  return (
    <div className="TimelineContainer">
      ...
      <Timeline active={4} bulletSize={24} lineWidth={2}>
        ...
        <Timeline.Item title="Software Engineer - TangoCode">
          <Text color="dimmed" size="md">Started as a Junior Software Engineer Intern and then worked as a Software Engineer I in <a href="https://tangocode.com" target="_blank"><Text variant="link" size="md" component="span">TangoCode</Text></a></Text>
        ...
        <Timeline.Item title="Adjunct Proffesor - ORT University">
