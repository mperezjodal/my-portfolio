    ...
    return (
        <div className="SecondInfoComponent">
            ...
            <p>
                ...
                Participated in programming competitions. Grade average: 93% (4.0 GPA), scholarship  available <a href="https://drive.google.com/file/d/1MG8yrrOKGgWv7fRpl6lMQjim82-2A-l_/view?usp=sharing" target="_blank">here</a>.
            </p>
            <br /> 
            <p>
                ...
                <br /> 
                Completed 1/3 of this degree. Scholarship <a href="https://drive.google.com/file/d/1fVrB1g8WBe0604VaLCB54IcJlB10dlm4/view?usp=sharing" target="_blank">here</a>.
            </p>
        </div>
    );
}
